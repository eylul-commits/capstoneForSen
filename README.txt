1. You need to download requirements (requirements.txt) to your environment (local or conda environment).
2. You need to install dlib using this command -> "pip3 install https://github.com/jloh02/dlib/releases/download/v19.22/dlib-19.22.99-cp310-cp310-win_amd64.whl"
